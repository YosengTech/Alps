                    ...
                    scope.$on("chartist.update", function (e, data) {
                        ...
                        if (scope.oncreated({
                            ...
                            type.on("mouseenter", function () {
                                var value, seriesName, self = $(this), parent = self.parent();
...
!function () {
    ...
    angular.module("app.email.ctrls", []).controller("EmailCtrl", ["$scope", "$modal", function ($scope, $modal) {
            $scope.labelColors = ["#5974d9", "#19c395", "#fc3644", "#232429", "#f1d44b"], $scope.labels = [{
                ...
                var l = $scope.labelColors.length, c = $scope.labelColors[Math.floor(Math.random() * l)];
...
!function () {
    ...
    angular.module("app.todo", []).factory("todoStorage", [function () {
            var STORAGE_ID = "_todo-task", store = {
                todos: [],
                get: function () {
...
!function () {
    ...
    angular.module("app.ui.ctrls", []).controller("ToastDemoCtrl", ["$scope", "$interval", function ($scope) {
            ...
            var MSGS = ["<strong>Error:</strong> Try submitting content again.", "a toast message...", "another toast message...", "<strong>Title:</strong> Toast message with <a href='#na' class='alert-link'>link</a>"], cntr = 0;
