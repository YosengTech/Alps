...
describe('directive: ma-dashboard-panel', function () {
    'use strict';
    var directive = require('../../../../../ng-admin/Main/component/directive/maDashboardPanel'), Entity = require('admin-config/lib/Entity/Entity'), $compile, scope, directiveUsage = '<ma-dashboard-panel collection="collection" entries="entries"></ma-dashboard-panel>';
    ...
    it("should display a title with a datagrid", function () {
        scope.collection = {
            title: function () { return 'Comments'; },
            name: function () { return 'myView'; },
