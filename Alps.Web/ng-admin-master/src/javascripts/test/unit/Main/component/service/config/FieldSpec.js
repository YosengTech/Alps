...
var Field = require('admin-config/lib/Field/Field'), ListView = require('admin-config/lib/View/ListView'), DashboardView = require('admin-config/lib/View/DashboardView'), Entity = require('admin-config/lib/Entity/Entity');
