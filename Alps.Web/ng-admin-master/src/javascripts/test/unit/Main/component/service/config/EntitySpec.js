...
var Entity = require('admin-config/lib/Entity/Entity'), DashboardView = require('admin-config/lib/View/DashboardView'), CreateView = require('admin-config/lib/View/CreateView');
