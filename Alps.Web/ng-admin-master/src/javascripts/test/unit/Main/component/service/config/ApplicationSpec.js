...
var Application = require('admin-config/lib/Application'), Entity = require('admin-config/lib/Entity/Entity'), DashboardView = require('admin-config/lib/View/DashboardView'), CreateView = require('admin-config/lib/View/CreateView');
describe("Service: Application config", function () {
    'use strict';
    describe('entity', function () {
        it('should store entity by name.', function () {
            var app = new Application(), entity = new Entity('myEntity');
    ...
    describe('view', function () {
        it('should returns all view of a certain type.', function () {
            var app = new Application(), entity1 = new Entity('myEntity1'), entity2 = new Entity('myEntity2'), dashboard = entity1.dashboardView().enable(), dashboard2 = entity2.dashboardView().enable(), createView = entity2.creationView().enable();
            app.addEntity(entity1);
            app.addEntity(entity2);
            var dashboards = app.getViewsOfType('DashboardView'), forms = app.getViewsOfType('CreateView'), lists = app.getViewsOfType('ListView');
    ...
    describe('getRouteFor', function () {
        it('should return the url specified in a view', function () {
            var app = new Application(), entity1 = new Entity('myEntity1'), view = entity1.dashboardView();
        ...
        it('should return the url specified in the entity when the URL is not specified in the view', function () {
            var app = new Application(), entity1 = new Entity('comments'), view = entity1.dashboardView();
        ...
        it('should call url() defined in the view if it\'s a function', function () {
            var app = new Application(), entity1 = new Entity('comments'), view = entity1.editionView();
    ...
    describe('getErrorMessageFor', function () {
        it('should return the global message with a simple string as body', function () {
            var app = new Application(), entity = new Entity(), response = {
                status: 500,
                data: 'myBody'
            };
            app.addEntity(entity);
