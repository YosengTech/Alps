...
describe('directive: ma-datagrid-pagination', function () {
    var directive = require('../../../../ng-admin/Crud/list/maDatagridPagination'), $compile, scope, directiveUsage = '<ma-datagrid-pagination page="{{ page }}" total-items="{{ totalItems }}" per-page="{{ itemsPerPage }}"></ma-datagrid-pagination>';
