...
describe('directive: ma-datagrid', function () {
    var directive = require('../../../../ng-admin/Crud/list/maDatagrid'), Entity = require('admin-config/lib/Entity/Entity'), Entry = require('admin-config/lib/Entry'), Field = require('admin-config/lib/Field/Field'), TextField = require('admin-config/lib/Field/TextField'), $compile, scope, directiveUsage = '<ma-datagrid name="{{ name }}" entries="entries" fields="fields" list-actions="listActions"' +
    ...
    it("should add columns", function () {
        var entry1 = new Entry('cat'), element;
