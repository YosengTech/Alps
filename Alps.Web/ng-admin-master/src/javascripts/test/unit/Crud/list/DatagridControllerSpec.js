...
describe('controller: ma-datagrid', function () {
    var DataGridController = require('../../../../ng-admin/Crud/list/maDatagridController'), Entity = require('admin-config/lib/Entity/Entity'), Entry = require('admin-config/lib/Entry');
