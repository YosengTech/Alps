    ...
    function maReferenceManyLinkColumn($state, Configuration) {
        return {
            ...
            link: function (scope) {
                ...
                scope.ids = scope.ids();
                var referenceEntity = scope.field.targetEntity().name(), relatedEntity = Configuration().getEntity(referenceEntity);
            ...
            template: '<a ng-repeat="ref in values track by $index" ng-click="gotoReference(ids[$index])" class="multiple">' +
