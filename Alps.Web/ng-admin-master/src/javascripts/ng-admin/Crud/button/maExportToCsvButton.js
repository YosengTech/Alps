            ...
            link: function (scope) {
                ...
                scope.exportToCsv = function () {
                    ...
                    ReadQueries.getAll(exportView, -1, scope.search(), $stateParams.sortField, $stateParams.sortDir)
                        ...
                        .then(function (rawEntries) { return ReadQueries.getFilteredReferenceData(exportView.getNonOptimizedReferences(), rawEntries); })
                        ...
                        var references = exportView.getReferences(), referencedData = angular.extend(nonOptimizedReferencedData, optimizedReferencedData), referencedEntries;
