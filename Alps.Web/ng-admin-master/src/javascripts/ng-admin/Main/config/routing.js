var layoutTemplate = require('../view/layout.html'), dashboardTemplate = require('../view/dashboard.html'), errorTemplate = require('../view/404.html');
    ...
    $stateProvider.state('dashboard', {
        ...
        resolve: {
            ...
            responses: ['$stateParams', '$q', 'collections', 'dataStore', 'Entry', 'ReadQueries', function ($stateParams, $q, collections, dataStore, Entry, ReadQueries) {
                    ...
                    var promises = {}, collection, collectionSortField, collectionSortDir, collectionName;
                    for (collectionName in collections) {
                        ...
                        promises[collectionName] = (function (collection, collectionSortField, collectionSortDir) {
                            ...
                            return ReadQueries
                                ...
                                .then(function (rawEntries) { return ReadQueries.getFilteredReferenceData(collection.getNonOptimizedReferences(), rawEntries); })
                                ...
                                var references = collection.getReferences(), referencedData = angular.extend(nonOptimizedReferencedData, optimizedReferencedData), referencedEntries;
