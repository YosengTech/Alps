...
(function (Alps) {
    ...
    (function (Directives) {
        var productskuselectorDirective = (function () {
            function productskuselectorDirective(uibModal, q, selectListService) {
                var delay = q.defer();
                ...
                d.link = function (scope, el, attributes, controller) {
                    ...
                    delay.promise.then(function (data) {
                        ...
                        if (!scope.selectlist)
                            return;
                        outerloop: for (var i = 0, len = scope.selectlist.length; i < len; i++) {
            ...
            productskuselectorDirective.Factory = function () {
                var directive = function (uibModal, q, selectListService) {
        ...
        Directives.SelectListModalCtrl = SelectListModalCtrl;
    })(Directives = Alps.Directives || (Alps.Directives = {}));
})(Alps || (Alps = {}));
//# sourceMappingURL=productSkuSelectorDirective.js.map